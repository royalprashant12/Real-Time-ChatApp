    ...
    <>
      <div className="flex h-screen items-center justify-center bg-gradient-to-br from-indigo-900 via-slate-900 to-blue-900">
        ...
        >
          ...
          <h2 className="text-xl text-center text-white font-semibold mb-4">Signup</h2>
          ...
          {errors.confirmPassword && (
            <span className="text-red-400 text-xs font-semibold pl-2">{errors.confirmPassword.message}</span>
          )}
          {/* Text & Button */}
